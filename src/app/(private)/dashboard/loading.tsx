export default function DashboardLoading() {
  return (
    <div className="relative flex min-h-[60vh] w-full items-center justify-center overflow-hidden">
      ...
      {/* card */}
      <div className="relative flex w-[min(360px,calc(100vw-48px))] flex-col items-center gap-4 rounded-3xl border border-zinc-200 bg-white/80 px-6 py-6 shadow-[0_24px_80px_rgba(0,0,0,0.10)] backdrop-blur">
        {/* animated ring */}
        ...
        <div className="text-center">
          <div className="text-sm font-extrabold tracking-tight text-zinc-900">A carregar…</div>
          <div className="mt-1 text-xs font-semibold text-zinc-500">Só um segundo enquanto preparamos tudo.</div>
        </div>
