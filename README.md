...
**IMPORTANTE**: Antes de começar a trabalhar neste projeto, leia a [PROJECT_DOCUMENTATION.md](./PROJECT_DOCUMENTATION.md) para entender completamente a visão, estrutura e princípios do projeto.

A documentação completa contém:
- Princípios UX/UI do projeto
